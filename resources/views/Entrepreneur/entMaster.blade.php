...
<body>
    ...
    <div class="showAppl">
        ...
        <div class="namePost">
            ...
            <button class="intersave" onclick="window.location.href='https://www.w3schools.com/css/css3_buttons.asp';">
                <p>เก็บเข้าแฟ้ม</p>
            </button>
            <button class="seeDetailAppl" onclick="window.location.href='/jobs/jobsDetail';">
